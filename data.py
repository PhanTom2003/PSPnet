...
from utils import Compose, Scale,RandomRotation, RandomMirror,Resize,Normalize_Tensor
import matplotlib.pyplot as plt 



def make_datapath_list(rootpath): #tạo đường dẫn đến file cần lấy data
    original_image_template=osp.join(rootpath,'JPEGImage','%s.jpg')
    annotation_image_template=osp.join(rootpath,'SegentationClass','%s.jpg')
    ...
    for line in open(train_ids):
        ...
        anno_path=(annotation_imge_template % img_id)
        
        
        train_img_list.append(img_path)
        train_anno_list.append(img_path)
...
class MyDataset(data.Dataset):
    def __init__(self, ig_list,anno_list,phase,transform):
